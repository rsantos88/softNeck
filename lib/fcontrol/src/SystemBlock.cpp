...
///
/// \brief Empty constructor. Creates a unity transfer fucntion.
///
...
///
/// \brief Vector constructor. Creates a transfer fucntion using the coefficients received as numerator and denominator.
/// The positive order of the z varaible is coincident with the vector position, therefore the first position (index 0) defines
/// the coefficient of z^0, second position (index 1) defines the coefficient of z^1, etc...
/// \param new_numCoef: An std::vector with the positive z polynomial Numerator coefficients
/// [c0, c1, .. , cn] -> (c0·z^0 + c1·z^1 + .. + cn·z^n).
/// \param new_denCoef: An std::vector with the positive z polynomial Deniminator coefficients
/// [c0, c1, .. , cn] -> (c0·z^0 + c1·z^1 + .. + cn·z^n).
///
...
/// \param new_denCoef: An std::vector with the positive z polynomial Deniminator coefficients
/// [c0, c1, .. , cn] -> (c0·z^0 + c1·z^1 + .. + cn·z^n).
/// \param new_gain: Scalar gain affecting the transfer function.
///
